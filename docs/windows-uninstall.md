# Uninstall Agent Taskboard on Windows

1. Quit Agent Taskboard from its system-tray menu.
2. Open **Settings > Apps > Installed apps**.
3. Find **Agent Taskboard**, open its menu, and select **Uninstall**.
...
To remove that retained data, close Agent Taskboard and delete these directories
for the current Windows user:

- `%APPDATA%\Agent Taskboard`
- `%LOCALAPPDATA%\Agent Taskboard`
